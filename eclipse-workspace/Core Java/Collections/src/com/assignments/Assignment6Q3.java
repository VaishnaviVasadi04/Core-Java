...
public class Assignment6Q3 {
	public static void main(String[] args)
	{
		...
		if(select.equals("a"))
		{
			...
			emp.add(new Employee(1001,"Vaishnavi","Aerospace",100000));
            emp.add(new Employee(1002,"Priyanka","Aerospace",75000));
            emp.add(new Employee(1003,"Chandini","ECE",40000));
            emp.add(new Employee(1004,"Swati","Chemical",80000));
            emp.add(new Employee(1005,"Nupur","Computer",60000));
